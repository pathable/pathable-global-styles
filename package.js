(function() {
  ...
  Package.onUse(function(api) {
    ...
    api.addFiles(['./imports/admin.scss', './imports/app.scss']);
    ...
    api.addAssets(
      [
        ...
        'fonts/FontAwesome4.7.0/fontawesome-webfont.eot',
        'fonts/FontAwesome4.7.0/fontawesome-webfont.svg',
        'fonts/FontAwesome4.7.0/fontawesome-webfont.ttf',
        'fonts/FontAwesome4.7.0/fontawesome-webfont.woff',
        'fonts/BreeSerif/BreeSerif-Regular.eot',
        'fonts/BreeSerif/BreeSerif-Regular.ttf',
        'fonts/BreeSerif/BreeSerif-Regular.woff',
        'fonts/Bungee/Bungee-Regular.eot',
        'fonts/Bungee/Bungee-Regular.ttf',
        'fonts/Bungee/Bungee-Regular.woff',
        ...
        'fonts/Maven/MavenProRegular.eot',
        'fonts/Maven/MavenProRegular.ttf',
        'fonts/Maven/MavenProRegular.woff',
        'fonts/Maven/MavenProMedium.eot',
        'fonts/Maven/MavenProMedium.ttf',
        'fonts/Maven/MavenProMedium.woff',
        'fonts/Maven/MavenProBold.eot',
        'fonts/Maven/MavenProBold.ttf',
        'fonts/Maven/MavenProBold.woff',
